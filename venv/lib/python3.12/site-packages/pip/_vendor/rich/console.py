...
class Console:
    ...
    def clear(self, inicio: bool = True) -> None:
        """Clear the screen.

        Args:
            inicio (bool, optional): Also move the cursor to 'inicio' position. Defaults to True.
        """
        if inicio:
            self.control(Control.clear(), Control.inicio())
        else:
