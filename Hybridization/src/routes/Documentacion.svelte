...
import ComputeWavefunction2D from '../lib/documentacion/ComputeWavefunction2D.svelte';
import ComputeWavefunction3D from '../lib/documentacion/ComputeWavefunction3D.svelte';
import ComputeWavefunction3DComplex from '../lib/documentacion/ComputeWavefunction3DComplex.svelte';
import GetN from '../lib/documentacion/GetN.svelte';
import GetL from '../lib/documentacion/GetL.svelte';
import GetM from '../lib/documentacion/GetM.svelte';
import GetRadius from '../lib/documentacion/GetRadius.svelte';
import GenerateSp from '../lib/documentacion/GenerateSp.svelte';
import GenerateSp2 from '../lib/documentacion/GenerateSp2.svelte';
import GenerateSp3 from '../lib/documentacion/GenerateSp3.svelte';
import GenerateSp2d from '../lib/documentacion/GenerateSp2d.svelte';
import GenerateSp3d from '../lib/documentacion/GenerateSp3d.svelte';
import GenerateSp3d2 from '../lib/documentacion/GenerateSp3d2.svelte';
import QElectron from '../lib/documentacion/QElectron.svelte';
import QHybridization from '../lib/documentacion/QHybridization.svelte';
import QPlots from '../lib/documentacion/QPlots.svelte';
import PlotRadial from '../lib/documentacion/PlotRadial.svelte';
import PlotSphericalReal from '../lib/documentacion/PlotSphericalReal.svelte';
import PlotSphericalImaginary from '../lib/documentacion/PlotSphericalImaginary.svelte';
import PlotWf2d from '../lib/documentacion/PlotWf2d.svelte';
import PlotWf3d from '../lib/documentacion/PlotWf3d.svelte';
import PlotSp2 from '../lib/documentacion/PlotSp2.svelte';
import PlotSp3 from '../lib/documentacion/PlotSp3.svelte';
import PlotSp2d from '../lib/documentacion/PlotSp2d.svelte';
import PlotSp from '../lib/documentacion/PlotSp.svelte';
import BienvenidaDocu from '../lib/documentacion/BienvenidaDocu.svelte';
